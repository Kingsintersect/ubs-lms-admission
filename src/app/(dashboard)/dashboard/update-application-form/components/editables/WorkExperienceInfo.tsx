...
export default function WorkExperienceInfo({
    ...
    // Check if this is a business school application (only they have work experience fields)
    ...
    const {
        ...
        initialData: {
            workExperience: isBusinessSchool && application.application.programType === ProgramType.BUSINESS_SCHOOL
                ? (application.application.workExperience || '')
                : '',
            currentPosition: isBusinessSchool && application.application.programType === ProgramType.BUSINESS_SCHOOL
                ? (application.application.currentPosition || '')
                : '',
            company: isBusinessSchool && application.application.programType === ProgramType.BUSINESS_SCHOOL
                ? (application.application.company || '')
                : '',
            yearsOfExperience: isBusinessSchool && application.application.programType === ProgramType.BUSINESS_SCHOOL
