    ...
    showPreview = true
        ...
        const allFiles: FileItem[] = [
            ...value.map(url => {
                ...
                const isImage = isImageFile(urlString);
                return {
                    url: urlString,
                    name: urlString.split('/').pop() || 'Unknown file',
                    type: isImage ? 'image' : 'document',
                    isImage
                };
            }),
        ...
        // }
        function isImageFile(fileOrUrl: string | object): boolean {
            // If it's a File object, check its type
            if (fileOrUrl instanceof File) {
                return fileOrUrl.type.startsWith('image/');
            }
            // alert(1)
            // If it's a string URL, check the extension
        ...
        const removeFile = (index: number) => {
            ...
            console.log('Current newFiles:', newFiles);
        ...
        const renderSingleFileUpload = () => {
            ...
            if (isEmpty) {
                ...
                return <div className="text-sm text-gray-400 italic">No file/document uploaded</div>;
            }

            // For single file with preview
            if (showPreview) {
                return (
            ...
            // Simple list view without preview
            return (
